...
public class KeyBindingCenter 
{
	...
	{		
		 ...
		 */
		inputManager.addMapping(KeyMapping.REPORT_REACTION.getID(), new JoyButtonTrigger(0,7));
		inputManager.addListener(simulatorActionListener, KeyMapping.REPORT_REACTION.getID());
