...
//            val image = roadTextureGenerator.getMapImage();
//            val texture = new Texture2D(awtLoader.load(image, true));
//            mat_terrain.setTexture("Alpha", texture);

            // add ROAD texture into the green layer (Tex2)
            Texture rock = assetManager.loadTexture("Textures/grass.png");//"Textures/Terrain/splat/grass.jpg");
...
//            // add ROAD texture into the red layer (Tex1)
//            val road = assetManager.loadTexture("Textures/road_texture.png");
