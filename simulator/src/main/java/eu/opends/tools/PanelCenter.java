...
public class PanelCenter
{
	...
	{  
		...
		int gaugesTop = 15;
		int bottommostPosition = getBottommostPosition();
		
        RPMgauge.setPosition(RPMgaugeLeft, gaugesTop + bottommostPosition);
        RPMIndicator.setLocalTranslation(RPMgaugeLeft + 93, gaugesTop + 93 + bottommostPosition, 0);
        reverseText.setLocalTranslation(RPMgaugeLeft + 50, 65 + bottommostPosition, 0);
        neutralText.setLocalTranslation(RPMgaugeLeft + 65, 65 + bottommostPosition, 0);
        manualText.setLocalTranslation(RPMgaugeLeft + 80, 65 + bottommostPosition, 0);
        driveText.setLocalTranslation(RPMgaugeLeft + 97, 65 + bottommostPosition, 0);
        
        resetGearTextPosition(isAutomaticTransmission);
        
        speedometer.setPosition(speedometerLeft, gaugesTop + bottommostPosition);
        speedIndicator.setLocalTranslation(speedometerLeft + 93, gaugesTop + 93 + bottommostPosition, 0);
        odometerText.setLocalTranslation(speedometerLeft + 20, 60 + bottommostPosition, 0);
	...
	public static void resetGearTextPosition(boolean isAutomaticTransmission)
	{
		...
		if(isAutomaticTransmission)
			currentGearText.setLocalTranslation(RPMgaugeLeft + 97, bottommostPosition + 48, 0);
		else			
			currentGearText.setLocalTranslation(RPMgaugeLeft + 80, bottommostPosition + 48, 0);
	}
