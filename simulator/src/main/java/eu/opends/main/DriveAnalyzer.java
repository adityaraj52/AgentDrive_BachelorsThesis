...
{	
    ...
    public String analyzerFilePath = "analyzerData/2011_05_30-14_52_59.txt";
	...
	private LinkedList<Double> steeringWheelPosList = new LinkedList<Double>();
	private LinkedList<Double> brakePedalPosList = new LinkedList<Double>();
	private LinkedList<Double> acceleratorPedalPosList = new LinkedList<Double>();
	...
	private void loadData() 
	{
		...
		{	
			...
			traveledDistance += (double) carPos.distance(previousPos);
			distanceList.add(traveledDistance);
			previousPos = carPos;
			
			steeringWheelPosList.add(dataReader.getSteeringWheelPosition(inputLineNext));
			
			acceleratorPedalPosList.add(dataReader.getAcceleratorPedalPosition(inputLineNext));
			
			brakePedalPosList.add(dataReader.getBrakePedalPosition(inputLineNext));
	...
	{
		//String driverName = dataReader.getNameOfDriver();
		
		//String drivingTask = dataReader.getNameOfDrivingTaskFile();

		DecimalFormat decimalFormat = new DecimalFormat("#0.00");
		String speedString = " speed: " + decimalFormat.format(speedList.get(targetIndex)) + " km/h";
		...
		String distanceString = "traveled: " + decimalFormat.format(distanceList.get(targetIndex)) + " m (total: " + 
				decimalFormat.format(traveledDistance) + " m)";
		
		String steeringWheelString = "steering wheel: " + decimalFormat.format(-100*steeringWheelPosList.get(targetIndex)) + "%";
		
		String acceleratorString = " accelleration: " + decimalFormat.format(100*acceleratorPedalPosList.get(targetIndex)) + "%";
		
		String brakeString = " brake: " + decimalFormat.format(100*brakePedalPosList.get(targetIndex)) + "%";
