...
public class TrafficCar extends Car
{
	...
	public TrafficCar(int id, Simulator sim, Vector3f initPos, TrafficCarData trafficCarData)
	{
        this.id = id;
		this.sim = sim;

        // Set the initial position
        // TODO: initial rotation towards another waypoint
		...
		followBox = new PlanExecuter(sim, this, trafficCarData.getFollowBoxSettings());
//		if(name.equals("car1")){
//		    followBox = new FollowBox(sim,this,trafficCarData.getFollowBoxSettings());
//		}else{
//		    followBox = new PB_WP_FollowBox(sim, this, trafficCarData.getFollowBoxSettings());
//		}
		}
	...
	public void update(Collection<TrafficCar> vehicleList)
	{
		if(!sim.isPause())
		{
			// update steering
	...
	private void steerTowardsPosition(Vector3f wayPoint) 
	{
		...
		steer(steeringDirection*steeringIntensity*0.5f); // 0.5 constant to prevent oscillations when driving faster
	...
	private void updateSpeed(Collection<TrafficCar> vehicleList)
	{
...
//			targetSpeed = 0;
	...
	private boolean obstaclesInTheWay(Collection<TrafficCar> vehicleList)
	{
