...
*/
	...
	public void update(Vector3f vehiclePos)
	{
		...
		*/
		...
		System.out.println("FB pos"+followBox.getWorldTranslation());
	...
	protected void performWayPointChange(int index)
	{
        ...
        System.out.println("SET: dist " + traveledDistance + ", time: " + traveledTime + ", index: " + index);
