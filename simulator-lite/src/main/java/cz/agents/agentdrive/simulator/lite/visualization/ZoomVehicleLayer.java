...
public class ZoomVehicleLayer extends CommonLayer{
    ...
    public void paint(Graphics2D canvas) {
        ...
        if (mainVehicle != null){
            ...
            if(settingRotation){
                double vehicleRotation = Math.atan2(mainVehicle.getHeading().y, mainVehicle.getHeading().x);
    ...
    private void drawVehicle(Graphics2D canvas, Vehicle vehicle){
        ...
        double vehicleRotation = Math.atan2(vehicle.getHeading().y, vehicle.getHeading().x);
        canvas.rotate(vehicleRotation);
