...
import cz.agents.agentdrive.simulator.lite.controller.PlanController;
import cz.agents.agentdrive.simulator.lite.controller.VelocityController;
    ...
    public void countSteeringAngle(){
        ...
        if (targetPos != null) {
            ...
            float actSteeringAngle = (float) Math.atan2(
                    heading.x*direction.y - heading.y*direction.x,
